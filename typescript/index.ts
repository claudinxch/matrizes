...
const printMultidimensionalArray = (arr: number[][], rows: number, cols: number) => {
...
const sumOfMatrices = sumMatrices(matriz1, matriz2)
const multiplicationOfMatrices = multiplyMatrices(matriz1, matriz2)

printMultidimensionalArray(sumOfMatrices, sumOfMatrices.length, sumOfMatrices.length)
console.log('---------')
printMultidimensionalArray(multiplicationOfMatrices, multiplicationOfMatrices.length, multiplicationOfMatrices.length)